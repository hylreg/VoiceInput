...
use voice_input_linux::{run_live_app, LinuxBackendKind, LinuxHostConfig, LinuxLiveAppConfig};
...
fn print_usage() {
    eprintln!("用法：cargo run -p voice-input-linux --bin voice-input-linux-app -- --backend ibus");
}
